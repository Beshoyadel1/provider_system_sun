      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius:
                widget.focusedBorderRadius ?? BorderRadius.circular(25),
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius:
                widget.enabledBorderRadius ?? BorderRadius.circular(25),
            borderSide: widget.borderColor != null
                ? BorderSide(color: widget.borderColor!)
                : BorderSide.none,
          ),
          ...
          suffixIcon: widget.isDatePicker == true
              ? IconButton(
                  ...
                  icon:
                      Icon(Icons.date_range, size: widget.suffixIconSize ?? 29),
