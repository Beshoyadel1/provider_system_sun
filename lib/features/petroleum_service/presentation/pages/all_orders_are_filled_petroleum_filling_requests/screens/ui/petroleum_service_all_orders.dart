...
import '../widgets/orders_page_petroleum_service_all_orders.dart';

class PetroleumServiceAllOrders extends StatelessWidget {
  const PetroleumServiceAllOrders({super.key});
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<NewOrdersCubit, NewOrdersState>(
        ...
        builder: (context, state) {
          ...
          return OrdersPagePetroleumServiceAllOrders(cubit: cubit);
        },
      ),
    );
  }
