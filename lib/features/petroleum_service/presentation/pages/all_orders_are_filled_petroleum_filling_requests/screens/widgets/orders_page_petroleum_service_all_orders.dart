...
import 'package:sun_web_system/features/petroleum_service/presentation/pages/all_orders_are_filled_petroleum_filling_requests/screens/widgets/filters_tabs_widget_petroleum_service_all_orders.dart';
...
class OrdersPagePetroleumServiceAllOrders extends StatelessWidget {
  const OrdersPagePetroleumServiceAllOrders({super.key, required this.cubit});
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              ...
              child: FiltersTabsWidgetPetroleumServiceAllOrders(
