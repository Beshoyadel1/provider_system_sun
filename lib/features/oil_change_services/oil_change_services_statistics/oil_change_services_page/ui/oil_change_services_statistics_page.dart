...
import '../widgets/orders_page_oil_change_services_statistics.dart';

class OilChangeServicesStatisticsPage extends StatelessWidget {
  const OilChangeServicesStatisticsPage({super.key});
    ...
    return BlocProvider(
      ...
      child: BlocBuilder<NewOrdersCubit, NewOrdersState>(
        ...
        builder: (context, state) {
          ...
          return OrdersPageOilChangeServicesStatistics(cubit: cubit);
        },
      ),
    );
  }
