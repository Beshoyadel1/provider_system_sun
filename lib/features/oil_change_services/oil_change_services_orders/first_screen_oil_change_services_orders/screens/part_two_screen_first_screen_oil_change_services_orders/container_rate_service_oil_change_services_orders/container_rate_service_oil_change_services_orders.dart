...
class ContainerRateServiceOilChangeServicesOrders extends StatelessWidget {
  const ContainerRateServiceOilChangeServicesOrders({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const DataInContainerRateServiceOilChangeServicesOrders(),
    );
  }
}
