...
import 'package:sun_web_system/features/oil_change_services/oil_change_services_orders/first_screen_oil_change_services_orders/screens/part_two_screen_first_screen_oil_change_services_orders/container_profits_from_ministry_of_oil_change_services_orders/data_in_container_profits_from_ministry_of_oil_change_services_orders.dart';
...
class ContainerProfitsFromMinistryOfOilChangeServicesOrders extends StatelessWidget {
  const ContainerProfitsFromMinistryOfOilChangeServicesOrders({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const DataInContainerProfitsFromMinistryOfOilChangeServicesOrders(),
    );
  }
}
