...
import 'package:sun_web_system/features/oil_change_services/oil_change_services_orders/first_screen_oil_change_services_orders/screens/part_two_screen_first_screen_oil_change_services_orders/container_profits_from_ministry_of_oil_change_services_orders/four_part_circle_oil_change_services_orders.dart';
import 'package:sun_web_system/features/oil_change_services/oil_change_services_orders/first_screen_oil_change_services_orders/screens/part_two_screen_first_screen_oil_change_services_orders/container_profits_from_ministry_of_oil_change_services_orders/services_legend_list_oil_change_services_orders.dart';
...
class SecondRowInDataInContainerProfitsFromMinistryOfOilChangeServicesOrders
    extends StatelessWidget {
  const SecondRowInDataInContainerProfitsFromMinistryOfOilChangeServicesOrders({
    super.key,
  });
      ...
      builder: (context, state) {
        ...
        return Row(
          ...
          children: [
            Flexible(
              flex: 1,
              child: FourPartCircleOilChangeServicesOrders(
                services: services,
              ),
            ),
            Flexible(
              flex: 1,
              child: ServicesLegendListOilChangeServicesOrders(
                services: services,
              ),
            ),
          ],
