...
import 'package:sun_web_system/features/oil_change_services/oil_change_services_orders/first_screen_oil_change_services_orders/screens/part_two_screen_first_screen_oil_change_services_orders/container_oil_change_services_orders_statistics/fast_line_with_fill_oil_change_services_orders.dart';
import 'package:sun_web_system/features/oil_change_services/oil_change_services_orders/first_screen_oil_change_services_orders/screens/part_two_screen_first_screen_oil_change_services_orders/container_oil_change_services_orders_statistics/first_row_in_data_in_container_oil_change_services_orders_statistics.dart';
...
class DataInContainerOilChangeServicesOrdersStatistics extends StatelessWidget {
  const DataInContainerOilChangeServicesOrdersStatistics({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      spacing: 10,
      children: [
        const FirstRowInDataInContainerOilChangeServicesOrdersStatistics(),
        FastLineWithFillOilChangeServicesOrders(),
      ],
    );
  }
}
