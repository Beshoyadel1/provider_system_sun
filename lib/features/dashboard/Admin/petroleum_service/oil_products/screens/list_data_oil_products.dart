...
import '../../../../../../features/dashboard/Admin/Petroleum_Service/Oil_Products/screens/design_list_oil_products/container_design_list_oil_products.dart';
...
class ListDataOilProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ContainerDesignListOilProducts(),
         if ((isMobile))
           ContainerDesignListAddProductOil(),
      ],
    );
  }
}
