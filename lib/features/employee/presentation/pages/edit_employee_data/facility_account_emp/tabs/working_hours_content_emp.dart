...
import 'package:sun_web_system/features/store_page/presentation/pages/store_widgets/working_hours_widget.dart';
...
class WorkingHoursContentEmp extends StatefulWidget {
  final EmployeeModel employee;

  const WorkingHoursContentEmp({
    super.key,
    required this.employee,
  });
  @override
  State<WorkingHoursContentEmp> createState() => _WorkingHoursContentEmpState();
}

class _WorkingHoursContentEmpState extends State<WorkingHoursContentEmp> {
