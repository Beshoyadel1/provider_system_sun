...
class FirstRowInDataInContainerProfitsFromMinistryOfOrderServicesStatistics
    extends StatelessWidget {
  const FirstRowInDataInContainerProfitsFromMinistryOfOrderServicesStatistics(
      {super.key});
