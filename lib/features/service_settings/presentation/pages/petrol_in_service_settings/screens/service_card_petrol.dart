...
import '../../../../../../../features/service_settings/presentation/pages/added_maintenance_and_internal_services_in_service_settings/screens/enter_name_laten_name_service.dart';
import '../../../../../../../features/service_settings/presentation/pages/added_maintenance_and_internal_services_in_service_settings/screens/select_tax_page.dart';
    ...
    return {
      ...
      "brands": service.brands.map((b) {
        return {
          ...
          "unifiedprice": b.provServiceBrand.unifiedprice,
          "cost": b.provServiceBrand.cost,
          "isunifiedprice": b.provServiceBrand.isunifiedprice,
        };
      }).toList(),
