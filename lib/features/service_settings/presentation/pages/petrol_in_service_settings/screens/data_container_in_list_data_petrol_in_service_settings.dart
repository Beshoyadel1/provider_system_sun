...
import 'package:sun_web_system/features/service_settings/presentation/pages/petrol_in_service_settings/screens/expansion_container_setting_petrol_widget.dart';
...
class DataContainerInListDataPetrolInServiceSettings extends StatelessWidget {
                ...
                return Column(
                  children: List.generate(state.services.length, (index) {
                    ...
                    return Padding(
                      ...
                      child: ExpansionContainerSettingPetrolWidget(
